        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Facebook size={20} className="cursor-pointer hover:text-blue-300" />
              <Twitter size={20} className="cursor-pointer hover:text-blue-300" />
              <Instagram size={20} className="cursor-pointer hover:text-blue-300" />
              <Youtube size={20} className="cursor-pointer hover:text-blue-300" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/academics" className="text-blue-100 hover:text-white">Academics</Link></li>
              <li><Link to="/administration" className="text-blue-100 hover:text-white">Administration</Link></li>
              <li><Link to="/activities" className="text-blue-100 hover:text-white">Activities</Link></li>
              <li><Link to="/gallery" className="text-blue-100 hover:text-white">Gallery</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/results" className="text-blue-100 hover:text-white">Results</Link></li>
              <li><Link to="/hostel" className="text-blue-100 hover:text-white">Hostel</Link></li>
              <li><Link to="/academics/academic-calendar" className="text-blue-100 hover:text-white">Academic Calendar</Link></li>
              <li><Link to="/academics/school-rules" className="text-blue-100 hover:text-white">School Rules</Link></li>
