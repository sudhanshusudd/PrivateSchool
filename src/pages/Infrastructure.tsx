...
import { Building, Wifi, BookOpen, FlaskConical, Computer, Trophy, Utensils, Bus } from 'lucide-react';
  ...
  const facilities = [
    {
      ...
      features: ['Smart Board Technology', 'Air Conditioned', 'Ergonomic Furniture', 'Natural Lighting'],
    },
    {
      icon: FlaskConical,
      title: 'Science Laboratories',
      description: 'State-of-the-art physics, chemistry, and biology labs with modern equipment.',
      features: ['Advanced Equipment', 'Safety Protocols', 'Research Facilities', 'Experiment Kits'],
    },
    {
      icon: Computer,
      title: 'Computer Labs',
      description: 'Multiple computer labs with latest hardware and software for digital literacy.',
      features: ['Latest Computers', 'High-Speed Internet', 'Programming Tools', '1:1 Computer Access'],
    },
    {
      icon: BookOpen,
      title: 'Library',
      description: 'Extensive collection of books, journals, and digital resources in our modern library.',
      features: ['50,000+ Books', 'Digital Resources', 'Reading Spaces', 'Research Section'],
    },
    {
      icon: Trophy,
      title: 'Sports Complex',
      description: 'Comprehensive sports facilities including playground, gymnasium, and indoor games.',
      features: ['Cricket Ground', 'Basketball Court', 'Swimming Pool', 'Gymnasium'],
    },
    {
      icon: Utensils,
      title: 'Cafeteria',
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Modern Learning Environment</h2>
            <p className="text-xl text-gray-600 leading-relaxed">
              Our campus spans across 15 acres and features state-of-the-art infrastructure 
              designed to provide students with the best possible learning environment. Every 
              facility is carefully planned to support academic excellence, creative expression, 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Everything needed for comprehensive education</p>
          </div>
              ...
              return (
                <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-3 text-center">{facility.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Additional Facilities</h2>
            <p className="text-xl text-gray-600">Supporting services for a complete educational experience</p>
          </div>
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-200">Our infrastructure at a glance</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Campus Security</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Health & Safety</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
