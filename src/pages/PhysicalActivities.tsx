...
const PhysicalActivities = () => {
  const sportsPrograms = [
    ...
    //   // coach: 'Mr. Amit Kumar',
    //   achievements: [
    //     "Multiple individual state records",
    //     "Swimming championship medals",
    //   ],
    ...
    // },
    {
      ...
      achievements: [
        "District athletics meet winners",
  ...
  const facilities = [
    {
      name: "Sports Complex",
      description:
        "Multi-purpose indoor facility with courts for basketball, badminton, and table tennis",
      features: [
        "Air conditioned",
    ...
    },
    {
      ...
      description:
        "Well-maintained basketball court for practice and tournaments with professional-grade flooring",
      features: [
        "Full-size court",
        "High-quality hoops",
    ...
    },
    {
      ...
      description:
        "400-meter track with field event areas for comprehensive athletics training",
      features: [
        "8-lane track",
        "Long jump pit",
        "Shot put area",
  ...
  const coachingPrograms = [
    {
      ...
      description:
        "Introduction to sports fundamentals and basic skills development",
      duration: "3 months",
      ageGroup: "6-10 years",
    },
    {
    ...
    },
    {
      ...
      description:
        "Professional training for serious athletes and competition preparation",
      duration: "Ongoing",
      ageGroup: "15+ years",
    },
    // {
    //   program: "Elite Squad",
    //   description:
    //     "Intensive training for state and national level competitions",
    //   duration: "Year-round",
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-blue-100">
            Comprehensive sports programs promoting fitness, teamwork, and
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Professional coaching and world-class facilities for all skill
              levels
            </p>
          </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              State-of-the-art infrastructure for optimal sports performance
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Structured training programs for all ages and skill levels
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                We prioritize student safety and well-being in all activities
              </p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Registration for new sports programs is now open. Don't miss the
            opportunity to be part of our winning teams!
          </p>
